...
class MedsJobs(object):
    ...
    def __init__(self, run_name, code_date, blacklist_file='blacklist-y1.txt', ini='params_bd.ini', nsplit=100, debug=0, local=False):
...
def test():
    ...
    fn='DES0454-4331-r-meds-spt-e-gold.fits.fz'
    j=MedsJobs(run_name, code_date, local=False, debug=debug)
